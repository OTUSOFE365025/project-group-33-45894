...
|------|------|-----------------------------------------------------|--------------|-------------------------------------------------------|
| R1   | Risk | External system failure (SSO or AI provider)        | Reliability  | Breaks uptime requirement; system becomes unavailable |
...
| R10  | Risk | Token validation or propagation fails between svcs | Security     | Causes inconsistent authentication/authorization      |
